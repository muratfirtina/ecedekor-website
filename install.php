    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-2xl">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl font-bold text-gray-900 mb-2">ECEDEKOR Kurulum</h1>
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between text-sm">
                    <span class="<?php echo $step >= 1 ? 'text-blue-600' : 'text-gray-400'; ?>">Hoş Geldiniz</span>
                    <span class="<?php echo $step >= 2 ? 'text-blue-600' : 'text-gray-400'; ?>">Veritabanı</span>
                    <span class="<?php echo $step >= 3 ? 'text-blue-600' : 'text-gray-400'; ?>">Site Ayarları</span>
                    <span class="<?php echo $step >= 4 ? 'text-blue-600' : 'text-gray-400'; ?>">Tamamlandı</span>
                </div>
            ...
            <?php if ($step == 1): ?>
                <div class="text-center">
                    <h2 class="text-2xl font-bold text-gray-900 mb-4">Kuruluma Hoş Geldiniz</h2>
                    ...
                    <div class="bg-blue-50 rounded-lg p-6 mb-8">
                        <h3 class="font-semibold text-blue-900 mb-3">Kurulum öncesi gereksinimler:</h3>
                    ...
                    <a href="?step=2" class="bg-blue-600 text-white px-8 py-3 rounded-lg hover:bg-blue-700 transition duration-300 inline-block">
            ...
            <?php elseif ($step == 2): ?>
                <div>
                    <h2 class="text-2xl font-bold text-gray-900 mb-4">Veritabanı Ayarları</h2>
                    ...
                    <form method="POST" class="space-y-6">
                        ...
                        <div class="flex space-x-4">
                            ...
                            <button type="submit" class="flex-1 bg-blue-600 text-white py-3 px-4 rounded-lg hover:bg-blue-700 transition duration-300">
            ...
            <?php elseif ($step == 3): ?>
                <div>
                    <h2 class="text-2xl font-bold text-gray-900 mb-4">Site Ayarları</h2>
            ...
            <?php elseif ($step == 4): ?>
                <div class="text-center">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900 mb-4">Kurulum Tamamlandı!</h2>
                    <p class="text-gray-600 mb-8">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="index.php" class="flex-1 bg-blue-600 text-white py-3 px-4 rounded-lg text-center hover:bg-blue-700 transition duration-300">
