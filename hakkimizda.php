...
$pageDescription = 'ECEDEKOR olarak 1998 yılından bu yana mobilya sektöründe kaliteli ürünler üretiyoruz. 25 yıllık deneyimimiz ve müşteri memnuniyeti odaklı hizmet anlayışımız.';
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
        <div class="animate-on-scroll">
            ...
            <p class="text-xl md:text-2xl mb-8 max-w-4xl mx-auto text-shadow opacity-90">
                25 yıllık deneyimimizle ahşap tamir ve dolgu malzemelerinde güvenilir çözüm ortağınız
            </p>
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div class="animate-on-scroll">
                <div class="mb-6">
                    <span class="bg-blue-100 text-blue-800 text-sm font-semibold px-3 py-1 rounded-full">Hikayemiz</span>
                </div>
                <h2 class="text-4xl font-bold text-gray-900 mb-6">
                    <?php echo getSetting('company_founded', '1998'); ?> Yılından Bu Yana Kalite
                </h2>
                <div class="space-y-4 text-gray-600 leading-relaxed">
                    <p>
                        ECEDEKOR, 1998 yılından bu yana mobilya sektöründe kullanılmak üzere dolgu macunu, 
                    ...
                    <p>
                        ...
                        çeşitli teknik malzeme ve hammeddelerin tedariğini yapmaktadır.
                    </p>
                    <p>
                ...
                <div class="mt-8 flex flex-col sm:flex-row gap-4">
                    <a href="<?php echo BASE_URL; ?>/urunler.php" 
                       class="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition duration-300 font-semibold text-center">
                        <i class="fas fa-box mr-2"></i>Ürünlerimizi İnceleyin
                    </a>
                    <a href="<?php echo BASE_URL; ?>/iletisim.php" 
                       class="border-2 border-blue-600 text-blue-600 px-6 py-3 rounded-lg hover:bg-blue-600 hover:text-white transition duration-300 font-semibold text-center">
            ...
            <div class="animate-on-scroll">
                <div class="relative">
                    <img src="<?php echo IMAGES_URL; ?>/company-history.jpg" 
                         alt="ECEDEKOR Tarihçesi" 
                         class="rounded-2xl w-full h-96 object-cover shadow-2xl"
                         onerror="this.src='<?php echo IMAGES_URL; ?>/placeholder-about.jpg'">
                    
                    <!-- Timeline Badge -->
                    <div class="absolute -bottom-6 -right-6 bg-blue-600 text-white p-6 rounded-2xl shadow-xl">
                        <div class="text-center">
                            <div class="text-3xl font-bold"><?php echo date('Y') - getSetting('company_founded', 1998); ?>+</div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="bg-white rounded-2xl p-8 card-shadow hover-scale animate-on-scroll text-center">
                ...
                <p class="text-gray-600">
                    25 yıllık deneyimimizle müşterilerimizin güvenini kazandık ve koruyoruz.
                </p>
            </div>
        </div>
    </div>
...
<section class="py-20 bg-blue-600">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-4xl font-bold text-white mb-4">Rakamlarla ECEDEKOR</h2>
            <p class="text-xl text-blue-100">Başarımızı gösteren rakamlar</p>
        </div>
        
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div class="text-center text-white animate-on-scroll">
                <div class="text-4xl lg:text-5xl font-bold mb-2"><?php echo date('Y') - getSetting('company_founded', 1998); ?>+</div>
                <div class="text-blue-200">Yıllık Deneyim</div>
            </div>
            <div class="text-center text-white animate-on-scroll">
                <div class="text-4xl lg:text-5xl font-bold mb-2">1000+</div>
                <div class="text-blue-200">Mutlu Müşteri</div>
            </div>
            <div class="text-center text-white animate-on-scroll">
                <div class="text-4xl lg:text-5xl font-bold mb-2">50+</div>
                <div class="text-blue-200">Ürün Çeşidi</div>
            </div>
            <div class="text-center text-white animate-on-scroll">
                <div class="text-4xl lg:text-5xl font-bold mb-2">20+</div>
                <div class="text-blue-200">İhracat Ülkesi</div>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="bg-white rounded-2xl p-8 card-shadow">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div class="text-center p-4 border border-gray-200 rounded-lg">
                            ...
                            <div class="font-semibold text-gray-900">TSE Belgesi</div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div class="text-center animate-on-scroll">
                ...
                <p class="text-gray-600 mb-4">
                    Sektörde 25+ yıl deneyime sahip yönetim kadromuz ile şirketi geleceğe taşıyoruz.
                </p>
...
<section class="py-16 bg-blue-600">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
        <div class="animate-on-scroll">
            <h2 class="text-3xl font-bold mb-4">ECEDEKOR Farkını Keşfedin</h2>
            <p class="text-xl mb-8 opacity-90">
                25 yıllık deneyimimizle size en iyi hizmeti sunmaya hazırız
            </p>
